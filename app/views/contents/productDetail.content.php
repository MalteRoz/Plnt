...
<section class="mt-8">
    <?php if ($response['status'] === 'success') :  ?>
        <?php foreach ($response['data'] as $product) : ?>
            <div class="flex flex-col items-center gap-8 w-full md:flex-row md:justify-start">
                ...
                <div class="md:flex md:flex-col md:gap-8 ">
                    ...
                    <div class="flex flex-col items-center gap-2 w-full">
                        <div class="flex justify-between w-full md:flex-col md:gap-4">
                            <div>
                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class="flex w-full justify-between">
                            <div class="flex flex-col items-center min-w-[22.5%] border-1 px-2 py-4 rounded-2xl border-zinc-300 bg-white shadow-[0_0_10px_rgba(0,0,0,0.1)] gap-2">
                        ...
                        <div class="flex justify-between w-full">
                            ...
                            <?php if ((isset($_SESSION['userid']))):  ?>
                                <form method="POST" action="/plnt/cart" class="min-w-[70%]">
                                    ...
                                    <button class=" text-white font-semibold bg-[#224820] p-3 rounded-xl w-full cursor-pointer">
                                        ADD TO CART
                                    </button>
                                </form>
                            <?php else: ?>
                                <form method="GET" action="/plnt/login" class="min-w-[70%]">
                                    <button type="submit" class="text-white font-semibold bg-[#224820] p-3 rounded-xl w-full cursor-pointer">
                                        SIGN IN TO PURCHASE
                                    </button>
                                </form>
                            <?php endif; ?>
